...
const formSchema = z.object({
  ...
  nombreBeneficiario: z
    ...
    .regex(/^[a-zA-Z0-9\s]+$/, { message: "El nombre no debe contener caracteres especiales" })
...
export default function Home() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // Create QR code URL
    const qrUrl = `${window.location.origin}/qr?q=${encodeURIComponent(base64)}`
    setQrValue(qrUrl)
  }
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>Ingrese la información requerida para generar el código QR de pago</CardDescription>
            </div>
            <Button variant="outline" size="sm" onClick={fillExampleData} className="flex items-center gap-2">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Puede ser el nombre de su negocio, o cualquier título que guste</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Ingrese los 18 dígitos de la CLABE" maxLength={18} {...field} />
                        </FormControl>
                        <FormDescription>Debe contener exactamente 18 dígitos numéricos</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Ingrese el nombre del beneficiario" maxLength={80} {...field} />
                        </FormControl>
                        <FormDescription>Máximo 80 caracteres, sin caracteres especiales</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
          ...
          <CardFooter className="flex flex-col items-center">
            ...
            <div className="mt-4 flex flex-col items-center gap-2">
              <p className="text-sm text-muted-foreground text-center max-w-md">
                Utilice este código QR para compartir sus detalles de pago. Descárguelo, mándelo, imprímalo, etc.
              </p>
